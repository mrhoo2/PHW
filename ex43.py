...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            a sickening melting suond as the mechanism is fused
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        clown costume than the last. They have't pulled their
        ...
        if action == "throw the bomb":
            ...
            disarm the bom. You die knowing they will probably
